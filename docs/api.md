...
This document provides detailed information about the StageBoard API endpoints, authentication, and usage.
...
_These endpoints require the user to have the `admin` role._
