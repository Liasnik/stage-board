...
watch(
  ...
  (newTasks) => {
    ...
    localInProgressTasks.value = newTasks.filter(
      (t) => t.status === "in_progress"
    );
    localCompletedTasks.value = newTasks.filter(
...
function handleDragChange(
  event: any,
  targetStatus: "pending" | "in_progress" | "completed"
) {
  ...
  const newAllTasks = [
    ...localPendingTasks.value,
    ...localInProgressTasks.value,
    ...localCompletedTasks.value,
  ];
